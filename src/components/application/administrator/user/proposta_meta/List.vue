  ...
  <PageWrapper>
    <PageHeader>
      <template v-slot:header-extra-content>
        <AddButton :onClick="addProposta">Adicionar novo</AddButton>
      </template>
    </PageHeader>
    <PageContent>
      <v-card>
...
import EditPropostaModal from '@/components/application/administrator/user/proposta_meta/EditPropostaModal.vue';
import DeletePropostaModal from '@/components/application/administrator/user/proposta_meta/DeletePropostaModal.vue';
